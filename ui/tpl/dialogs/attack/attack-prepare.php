...
<?php else:?>
    <?php 
        // Template variables
        $entityPrepareCapability = Stephino_Rpg_Db_Table_Convoys::CONVOY_TYPE_ATTACK;
        $entityPrepareSingular   = esc_html__('Prepare an attack with:', 'stephino-rpg');
        $entityPreparePlural     = esc_html__('Prepare an attack with one of the following:', 'stephino-rpg');
        $entityPrepareNotAllowed = esc_html__('This game does not allow attacks', 'stephino-rpg');
