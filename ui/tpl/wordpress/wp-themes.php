        ...
        <div class="col-12 banner">
            ...
            <div class="info">
                ...
                <?php if (null !== $themeSlug): ?>
                    &gt; <?php echo esc_html($installedThemes[$themeSlug]->getName());?> <?php if (!$installedThemes[$themeSlug]->isActive()):?>(<?php echo esc_html__('Inactive', 'stephino-rpg');?>)<?php endif;?>
                <?php endif;?>
            </div>
        </div>
    </div>
            ...
            <?php foreach(Stephino_Rpg_Utils_Themes::getInstalled() as $theme): ?>
                <div class="col-12 col-lg-6 col-xl-4 p-2" data-role="theme-card" data-slug="<?php echo esc_attr($theme->getThemeSlug());?>">
                    ...
                    <div class="card col-12 <?php if ($theme->isActive()):?>active<?php endif;?>">
                        <h4>
                            <?php if (!$theme->isDefault()):?><?php echo esc_html__('Theme', 'stephino-rpg');?>:<?php endif;?>
                            <b><?php echo esc_html($theme->getName());?></b>
                            <?php echo esc_html__('by', 'stephino-rpg');?> <a rel="noreferrer" target="_blank" href="<?php echo esc_attr($theme->getAuthorUrl());?>"><?php 
                                echo strlen($theme->getAuthor()) 
                                    ? esc_html($theme->getAuthor())
                                    : esc_html__('Unknown', 'stephino-rpg');
                            ?></a>
                            <?php if ($theme->isDefault()):?>
                                (<?php echo esc_html__('Design locked', 'stephino-rpg');?>)
                            <?php endif;?>
                            <?php if (!$theme->isDefault() && !$theme->isActive()):?>
                                <span data-role="delete" class="btn btn-danger float-right">&times;</span>
                            <?php endif;?>
                        </h4>
