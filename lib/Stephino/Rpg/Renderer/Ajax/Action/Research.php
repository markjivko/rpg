...
class Stephino_Rpg_Renderer_Ajax_Action_Research extends Stephino_Rpg_Renderer_Ajax_Action {
    ...
    public static function ajaxQueue($data) {
        ...
        $researchAreaConfigId = $researchFieldConfig->getResearchArea()->getId();
        ...
        list(
            ...
            $researchCostData,
            $researchAffordList
        ) = self::getResearchAreaInfo($researchAreaConfigId);
        ...
        // Get the production
        $researchFieldProduction = Stephino_Rpg_Renderer_Ajax_Action::getProductionData(
            $researchFieldConfig, 
        ...
        self::spend($researchCostData[$researchFieldConfigId], null, 1, $researchFieldConfigs[$researchFieldConfigId]);
    ...
    /**
     * Dequeue a research field
     * 
     * @param array $data Data containing <ul>
     * <li><b>researchFieldConfigId</b> (int) Research Field Configuration ID</li>
     * </ul>
     */
    public static function ajaxDequeue($data) {
        // Get the arguments
        $cityId = isset($data[self::REQUEST_CITY_ID]) ? intval($data[self::REQUEST_CITY_ID]) : 0;
        $researchFieldConfigId = isset($data[self::REQUEST_RESEARCH_FIELD_CONFIG_ID]) ? intval($data[self::REQUEST_RESEARCH_FIELD_CONFIG_ID]) : 0;
