...
/**
 * Stephino_Rpg_Config_Tutorials
 * 
 * @title      Tutorials
 * @desc       Holds the configuration for Tutorials
 * @copyright  (c) 2021, Stephino
 * @author     Mark Jivko <stephino.team@gmail.com>
 * @package    stephino-rpg
 * @license    GPL v3+, https://gnu.org/licenses/gpl-3.0.txt
 */
class Stephino_Rpg_Config_Tutorials extends Stephino_Rpg_Config_Item_Collection {
     ...
     */
    const SINGLE_CLASS = Stephino_Rpg_Config_Tutorial::class;

    /**
     * Get a single configuration item
     * 
     * @param int $id Tutorial ID
     * @return Stephino_Rpg_Config_Tutorial|null
     */
