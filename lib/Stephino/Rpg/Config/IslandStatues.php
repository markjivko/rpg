...
/**
 * Stephino_Rpg_Config_IslandStatues
 * 
 * @title      Island Statues
 * @desc       Holds the configuration for Island Statues
 * @copyright  (c) 2020, Stephino
 * @author     Mark Jivko <stephino.team@gmail.com>
 * @package    stephino-rpg
 * @license    GPL v3+, gnu.org/licenses/gpl-3.0.txt
 */
class Stephino_Rpg_Config_IslandStatues extends Stephino_Rpg_Config_Item_Collection {

    /**
     * Serialization Key - Must be defined by each item individually
     */
    const KEY = 'islandStatues';

    /**
     * Class name of corresponding Single Item
     */
    const SINGLE_CLASS = Stephino_Rpg_Config_IslandStatue::class;

    /**
     * Get a single configuration item
     * 
     * @param int $id Island Statue ID
     * @return Stephino_Rpg_Config_IslandStatue|null
     */
