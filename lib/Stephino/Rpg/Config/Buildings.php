...
/**
 * Stephino_Rpg_Config_Buildings
 * 
 * @title      Buildings
 * @desc       Holds the configuration for Buildings
 * @copyright  (c) 2021, Stephino
 * @author     Mark Jivko <stephino.team@gmail.com>
 * @package    stephino-rpg
 * @license    GPL v3+, https://gnu.org/licenses/gpl-3.0.txt
 */
class Stephino_Rpg_Config_Buildings extends Stephino_Rpg_Config_Item_Collection {
     ...
     */
    const SINGLE_CLASS = Stephino_Rpg_Config_Building::class;

    /**
     * Get a single configuration item
     * 
     * @param int $id Building ID
     * @return Stephino_Rpg_Config_Building|null
     */
