...
/**
 * Stephino_Rpg_Config_PremiumPackages
 * 
 * @title      Premium Packages
 * @desc       Holds the configuration for Premium Packages
 * @copyright  (c) 2021, Stephino
 * @author     Mark Jivko <stephino.team@gmail.com>
 * @package    stephino-rpg
 * @license    GPL v3+, gnu.org/licenses/gpl-3.0.txt
 */
class Stephino_Rpg_Config_PremiumPackages extends Stephino_Rpg_Config_Item_Collection {

    /**
     * Serialization Key - Must be defined by each item individually
     */
    const KEY = 'premiumPackages';

    /**
     * Class name of corresponding Single Item
     */
    const SINGLE_CLASS = Stephino_Rpg_Config_PremiumPackage::class;

    /**
     * Get a single configuration item
     * 
     * @param int $id Premium Package ID
     * @return Stephino_Rpg_Config_PremiumPackage|null
     */
